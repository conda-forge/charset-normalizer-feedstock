...
pixi add charset-normalizer
# for installing globally
pixi global install charset-normalizer
```
...
It is possible to list all of the versions of `charset-normalizer` available on your platform:
...
```
pixi search charset-normalizer --channel conda-forge
```
